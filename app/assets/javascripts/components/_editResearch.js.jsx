           ...
           <div>
                        <div className="form-group">
                            ...
                            <div className="col-sm-10">
                                <input type="text" style = {inputStyle} className="form-control"  placeholder="Enter email" name="research[title]" value ={this.props.research.title}/>
                            </div>
                        </div>
                       ...
                       <div className="form-group">
                            ...
                            <div className="col-sm-10">
                                <input name="research[date_started]" type="date" style = {inputStyle} className="form-control"  placeholder=""/>
                            </div>
                        </div>
                        ...
                        <div className="form-group">
                            ...
                            <div className="col-sm-10">
                                <input name="research[commodity]" type="text"  style = {inputStyle} className="form-control" id="commodity" placeholder="Enter email"/>
                            </div>
                        </div>
                        <div className="form-group">
